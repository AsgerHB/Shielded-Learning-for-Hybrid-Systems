...
/* formula 1 */
strategy Deterrence1000 = minE (aov/120 + switches/2 + (number_deaths > 0)*1000 ) [<=120] {} -> {t, v, p, l}: <> elapsed >= 120
...
/* formula 6 */
strategy Deterrence100 = minE (aov/120 + switches/2 + (number_deaths > 0)*100 ) [<=120] {} -> {t, v, p, l}: <> elapsed >= 120
...
/* formula 11 */
strategy Deterrence10 = minE (aov/120 + switches/2 + (number_deaths > 0)*10 ) [<=120] {} -> {t, v, p, l}: <> elapsed >= 120
...
/* formula 16 */
strategy Deterrence0 = minE (aov/120 + switches/2 + (number_deaths > 0)*0 ) [<=120] {} -> {t, v, p, l}: <> elapsed >= 120
