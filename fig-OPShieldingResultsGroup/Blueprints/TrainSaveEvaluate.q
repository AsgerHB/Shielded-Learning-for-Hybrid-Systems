...
/* formula 1 */
strategy Deterrence1000 = minE (aov/120 + switches/2 + (number_deaths > 0)*1000 ) [<=120] {p} -> {t, v, l}: <> elapsed >= 120

/* formula 2 */
saveStrategy("%resultsdir%/Deterrence1000.strategy.json", Deterrence1000)

/* formula 3 */
E[<=120;%checks%] (max:aov/120 + switches/2) under Deterrence1000
...
/* formula 6 */
strategy Deterrence100 = minE (aov/120 + switches/2 + (number_deaths > 0)*100 ) [<=120] {p} -> {t, v, l}: <> elapsed >= 120

/* formula 7 */
saveStrategy("%resultsdir%/Deterrence100.strategy.json", Deterrence100)

/* formula 8 */
E[<=120;%checks%] (max:aov/120 + switches/2) under Deterrence100
...
/* formula 11 */
strategy Deterrence10 = minE (aov/120 + switches/2 + (number_deaths > 0)*10 ) [<=120] {p} -> {t, v, l}: <> elapsed >= 120

/* formula 12 */
saveStrategy("%resultsdir%/Deterrence10.strategy.json", Deterrence10)

/* formula 13 */
E[<=120;%checks%] (max:aov/120 + switches/2) under Deterrence10
...
/* formula 16 */
strategy Deterrence0 = minE (aov/120 + switches/2 + (number_deaths > 0)*0 ) [<=120] {p} -> {t, v, l}: <> elapsed >= 120

/* formula 17 */
saveStrategy("%resultsdir%/Deterrence0.strategy.json", Deterrence0)

/* formula 18 */
E[<=120;%checks%] (max:aov/120 + switches/2) under Deterrence0
