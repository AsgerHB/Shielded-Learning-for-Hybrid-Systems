...
begin
	...
	function plot_accuracies(spa_values::Vector{Int}, accuracies; 
				samples_per_square, squares_to_test, plotargs...)
		...
		plot(spa_values, accuracies,
			...
			xlabel="N", 
			ylabel="accuracy",
			title="$(samples_taken) checks done per datapoint."
			;plotargs...)
	...
	function plot_accuracies(grids::Vector{Grid}, accuracies; 
		...
		plot(granularities, accuracies,
			...
			xticks=(granularities, ["G=$G" for G in granularities]),
			xrotation=90,
			size=(800, 600),
			label="$(samples_per_axis^2) samples",
...
- `samples_per_square =`  $(Child("samples_per_square", NumberField(0:100:100000, default=(@nbparam "samples_per_square" 100))))
- `squares_to_test =`  $(Child("squares_to_test", NumberField(0:100:100000, default=(@nbparam "squares_to_test" 100))))
"""
end)
...
Ns, accuracies = compute_accuracies(grid, spa_values; spa_test_params...)

# ╔═╡ a6771752-a238-4186-90a1-0f80c4a9524c
p1 = plot_accuracies(spa_values, accuracies; spa_test_params...)

# ╔═╡ e969a1f3-0659-473c-be9f-86efa1acad1e
p2 = plot_accuracies(spa_values[5:end], accuracies[5:end]; spa_test_params...)

# ╔═╡ 6018ea77-c389-4abf-a2d9-a97afd99dc7d
plot_accuracies(spa_values[10:end], accuracies[10:end]; spa_test_params...)
...
- `samples_per_axis =`  $(Child("samples_per_axis", NumberField(1:30, default=5)))
"""
end)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "6e12a688aa3a04a97328df96808e62d0107f299f"
