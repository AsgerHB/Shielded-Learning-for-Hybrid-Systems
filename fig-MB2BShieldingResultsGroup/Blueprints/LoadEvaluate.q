...
/* formula 1 */
strategy Deterrence1000 = loadStrategy {} -> {p[0], v[0], p[1], v[1]}("%resultsdir%/Deterrence1000.strategy.json")
...
/* formula 5 */
strategy Deterrence100 = loadStrategy {} -> {p[0], v[0], p[1], v[1]}("%resultsdir%/Deterrence100.strategy.json")
...
/* formula 9 */
strategy Deterrence10 = loadStrategy {} -> {p[0], v[0], p[1], v[1]}("%resultsdir%/Deterrence10.strategy.json")
...
/* formula 13 */
strategy Deterrence0 = loadStrategy {} -> {p[0], v[0], p[1], v[1]}("%resultsdir%/Deterrence0.strategy.json")
