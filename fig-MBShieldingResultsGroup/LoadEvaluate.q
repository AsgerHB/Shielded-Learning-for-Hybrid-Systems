...
/* formula 1 */
strategy Deterrence1000 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("/home/asger/Experiments/F1/Deterrence1000.strategy.json")
...
/* formula 5 */
strategy Deterrence100 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("/home/asger/Experiments/F1/Deterrence100.strategy.json")
...
/* formula 9 */
strategy Deterrence10 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("/home/asger/Experiments/F1/Deterrence10.strategy.json")
...
/* formula 13*/
strategy Deterrence0 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("/home/asger/Experiments/F1/Deterrence0.strategy.json")
