...
/* formula 1 */
strategy DeathCosts1000 = minE (LearnerPlayer.fired + number_deaths*1000 ) [<=120] {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}: <> time >= 120

/* formula 2 */
saveStrategy("/home/asger/Experiments/F1/DeathCosts1000.strategy.json", DeathCosts1000)
...
/* formula 6 */
strategy DeathCosts100 = minE (LearnerPlayer.fired + number_deaths*100 ) [<=120] {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}: <> time >= 120

/* formula 7 */
saveStrategy("/home/asger/Experiments/F1/DeathCosts100.strategy.json", DeathCosts100)
...
/* formula 11 */
strategy DeathCosts10 = minE (LearnerPlayer.fired + number_deaths*10 ) [<=120] {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}: <> time >= 120

/* formula 12 */
saveStrategy("/home/asger/Experiments/F1/DeathCosts10.strategy.json", DeathCosts10)
