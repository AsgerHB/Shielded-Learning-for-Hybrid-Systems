...
/* formula 1 */
strategy DeathCosts1000 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("%resultsdir%/DeathCosts1000.strategy.json")
...
/* formula 5 */
strategy DeathCosts100 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("%resultsdir%/DeathCosts100.strategy.json")
...
/* formula 9 */
strategy DeathCosts10 = loadStrategy {} -> {p[0], v[0], p[1], v[1], p[2], v[2]}("%resultsdir%/DeathCosts10.strategy.json")
