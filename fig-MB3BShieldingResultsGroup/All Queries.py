...
def clear_results():
    ...
    if exists(backupdir) and exists(resultsdir):
...
if __name__ == "__main__":
    ...
    for i in range(repeats):
        ...
        run_experiment( experiment = "Layabout",
                        model = "MB__ShieldedLayabout.xml",          # shield_enabled = true; layabout = true
        ...
        for runs in  learning_runs:
            ...
            run_experiment( experiment = "PreShielded",
                            model = "MB__Shielded.xml",      # shield_enabled = true
            ...
            run_experiment( experiment = "NoShield",
                            model = "MB__Unshielded.xml",    # shield_enabled = false
